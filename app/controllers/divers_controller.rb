class DiversController < ApplicationController
  ...
  before_action :all_dives, only: [:show]
  ...
  def create
    ...
    redirect_to dashboard_path, flash: { success: "Diver Created!" }
  end
  ...
  def deactivate
    ...
    redirect_to dashboard_path, { flash: { success: 'Diver has been deactivated!' } }
  end
